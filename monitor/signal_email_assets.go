...
func emailAssetFindings(domain string, results []emailAssetResult) []finding {
	...
	if originMissing > 0 {
		...
		action = "Build and deploy the site from a checkout that contains mmm/ur.io/react/public/images/emails (the Makefile's sync-public target mirrors it into the build). Do not copy files into live containers."

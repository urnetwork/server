...
forward_signal() {
  local signal_name="$1"
  # Async shell children may inherit ignored INT. TERM always reaches the
  # timeout monitor and requests the same graceful runner cancellation.
  # Preserve the wrapper's cancellation status regardless of input signal.

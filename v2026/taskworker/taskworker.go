...
var removedTaskTargets = []string{
	...
	"github.com/urnetwork/server/v2026/controller.RefreshTransferBalances",
	...
	"github.com/urnetwork/server/v2026/taskworker/work.RemoveOldExtenderLatencies",
}
...
func initTaskWorkerWithSettings(ctx context.Context, settings *task.TaskWorkerSettings, profile WorkloadProfile) *task.TaskWorker {
	...
	addProfileTargets(taskWorker, profile,
		...
		task.NewTaskTargetWithPost(
			...
			"github.com/urnetwork/server/v2026/taskworker/work.RemoveExpiredWalletAuthChallenges",
		),
		task.NewTaskTargetWithPost(
			work.RemoveExpiredWalletNonces,
			work.RemoveExpiredWalletNoncesPost,
			"github.com/urnetwork/server/v2026/taskworker/work.RemoveExpiredWalletNonces",
		),
		task.NewTaskTargetWithPost(

...
func TestEmailAssetsSignalSyntheticStaleSiteBundleRootCause(t *testing.T) {
	...
	for _, want := range []string{
		...
		"sync-public",
		"local Mmm checkout containing b4b229c5c",
		"intended local SDK checkout",
		"record any participating local diffs",
		"Web service",
		"release-order blocker",
		"API and Taskworker",
		"server commit ec6e3b92",
		"not active yet",
		"current broken-email dependency",
		"do not roll back or redeploy an otherwise-correct sender",

...
func TestIsDoneErrorRequiresExplicitShutdownSignal(t *testing.T) {
	cases := []struct {
		...
		{name: "legacy punctuated string", value: "Done.", done: true},
		...
		{name: "legacy punctuated error", value: errors.New("Done."), done: true},
		{name: "wrapped legacy error", value: fmt.Errorf("synthetic shutdown: %w", errors.New("Done")), done: true},
		{name: "wrapped punctuated error", value: fmt.Errorf("synthetic shutdown: %w", errors.New("Done.")), done: true},
		{name: "joined shutdown", value: errors.Join(context.Canceled, DbContextDoneError), done: true},
		{name: "joined legacy shutdown", value: errors.Join(errors.New("Done"), errors.New("Done.")), done: true},
		...
		{name: "punctuated diagnostic", value: errors.New("Done. Synthetic invariant failed")},
		{name: "punctuated string diagnostic", value: "Done. Synthetic invariant failed"},

...
func TestCompanionEscrowAndCheckpoint(t *testing.T) { bringyour.DefaultTestEnv().Run(func() {
...
func TestClosePartialContractWithCheckpoint(t *testing.T) { bringyour.DefaultTestEnv().Run(func() {
    ctx := context.Background()
...
func TestClosePartialCompanionContractWithCheckpoint(t *testing.T) { bringyour.DefaultTestEnv().Run(func() {
    ctx := context.Background()

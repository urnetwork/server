...
func TestLegacyByJwt(t *testing.T) { bringyour.DefaultTestEnv().Run(func() {
...
func TestFullByJwt(t *testing.T) { bringyour.DefaultTestEnv().Run(func() {
	ctx := context.Background()
	...
	assert.Equal(t, byJwt.SessionIds, parsedByJwt.SessionIds)
...
func TestFullByJwtWithClientId(t *testing.T) { bringyour.DefaultTestEnv().Run(func() {
	ctx := context.Background()
	...
	assert.Equal(t, byJwt.SessionIds, parsedByClientJwt.SessionIds)

...
// GetClientKey backs `GET /key/<client_id>`. Unauthenticated by
// design: the value is a public Ed25519 key whose whole purpose is to
// be fetchable by any peer that wants to bind a client_id to a
// signing key out-of-band of the contract pipeline.
